...
/// Each handler method returns this enum to control whether the node's
/// children should be traversed or not. That is, if the handler returns
/// `TraverseFlow::Break`, the children won't be visited.
...
pub trait Handler {
  ...
  fn block_stmt(
    &mut self,
    _n: &ast_view::BlockStmt,
    _ctx: &mut Context,
  ) -> TraverseFlow {
    TraverseFlow::Continue
  }
  fn bool(&mut self, _n: &ast_view::Bool, _ctx: &mut Context) -> TraverseFlow {
    TraverseFlow::Continue
  }
  fn break_stmt(
    &mut self,
    _n: &ast_view::BreakStmt,
    _ctx: &mut Context,
  ) -> TraverseFlow {
    TraverseFlow::Continue
  }
  ...
  fn null(&mut self, _n: &ast_view::Null, _ctx: &mut Context) -> TraverseFlow {
    TraverseFlow::Continue
  }
  fn number(
    &mut self,
  ...
  fn str(&mut self, _n: &ast_view::Str, _ctx: &mut Context) -> TraverseFlow {
    TraverseFlow::Continue
  }
  ...
  fn throw_stmt(
    &mut self,
    _n: &ast_view::ThrowStmt,
    _ctx: &mut Context,
  ) -> TraverseFlow {
    TraverseFlow::Continue
  }
  fn tpl(&mut self, _n: &ast_view::Tpl, _ctx: &mut Context) -> TraverseFlow {
    TraverseFlow::Continue
  }
  fn tpl_element(
    &mut self,
    _n: &ast_view::TplElement,
    _ctx: &mut Context,
  ) -> TraverseFlow {
    TraverseFlow::Continue
  }
