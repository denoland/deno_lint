...
mod tests {
  ...
  #[test]
  fn err_1() {
    assert_lint_err::<NoImportAssign>("import mod1 from 'mod'; mod1 = 0", 25);

    assert_lint_err::<NoImportAssign>("import mod2 from 'mod'; mod2 += 0", 25);

    assert_lint_err::<NoImportAssign>("import mod3 from 'mod'; mod3++", 25);
  }
